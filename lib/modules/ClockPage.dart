...
class _ClockPageState extends State<ClockPage> {
  ...
  Widget build(BuildContext context) {
    var now = DateTime.now().toUtc().add(const Duration(hours: 3));

    var formattedDate = DateFormat('EEE, d MMM').format(now.toLocal());
    var timezoneString =
        now.toLocal().timeZoneOffset.toString().split('.').first;
    var offsetSign = '';
